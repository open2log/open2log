...
* If the server can't respond for the requests of adding more products from the offline database try again later. Add rate limiting per IP-address for adding new products.
